<img src="assets/varun-madala-engineering-banner.png" alt="Varun Madala - Backend, Cloud and Distributed Systems" width="100%" />
...
[![Location](https://img.shields.io/badge/Atlanta-Georgia-24292F?style=for-the-badge&logo=googlemaps)](https://www.google.com/maps/place/Atlanta,+GA)
...
```mermaid
flowchart LR
    A[Understand domain] --> B[Define contracts]
    B --> C[Design for failure]
    C --> D[Automate tests and delivery]
